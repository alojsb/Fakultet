...
namespace DLWMS.WinApp.IspitBrojIndeksa
{
    public partial class frmStipendijaAddEditBrojIndeksa : Form
    {
        ...
        private void frmStipendijaAddEditBrojIndeksa_Load(object sender, EventArgs e)
        {
            ...
            {
                // cmbStudent
                var student = db.Studenti.FirstOrDefault(s => s.Id == ss.Id);
        ...
        private void btnSacuvaj_Click(object sender, EventArgs e)
        {
            ...
            if (studentId == null || stipendijaId == 0 || string.IsNullOrWhiteSpace(godinaText))
            {
                MessageBox.Show("Molimo odaberite studenta, stipendiju i godinu.");
                return;
            }
            ...
            var stipendijaGodina = db.StipendijeGodineBrojIndeksa
                .FirstOrDefault(sg =>   sg.StipendijaId == stipendijaId &&
                                        sg.Godina == godina);
